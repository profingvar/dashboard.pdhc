...
Note (#471 item 1): the ObservationCache POST /admin/cache/scrub route and the
``flask cache-sweep`` CLI were removed with the rest of the cache surface
(operator #469 Q6 = live CDR1 reads only). Historical rows with
event_type='cache_scrub' remain visible in the audit view below.
"""
...
from app.models import DashboardAudit
